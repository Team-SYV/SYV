...
from models.answer import CreateAnswerInput, CreateAnswerResponse
...
def create_answer(answer_data: CreateAnswerInput, request: Request, supabase: Client = Depends(get_supabase)):
